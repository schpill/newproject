...
get_lang(){global$ca;return'fr';}function
...
true;}function
navigation($re){global$ia,$w,$Ub,$h;if($re=="auth"){$Hc=true;foreach((array)$_SESSION["pwds"]as$Qh=>$vg){foreach($vg
as$N=>$Lh){foreach($Lh
